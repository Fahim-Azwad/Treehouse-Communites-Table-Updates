...
:: DIRECTORIES
	...
	If "%hostname%" == "ROOTSMG-PF2ZPQJ" (
		...
		SET dir_postgresDBtst=C:\Users\JoshuaMayberry\Documents\UnitTester
	) ELSE (
		SET exe_python=C:\Program Files\Python310\python.exe
		SET dir_log=C:\Users\jmayberry\Stonebrink Leads Dropbox\Joshua Mayberry\systems_data\logs
		SET dir_postgresDBtst=C:\Projects\UnitTester
	)

:: LOG OUTPUT
	SET LOGFILE=%dir_log%\unit-tester__%currentTime%.log
